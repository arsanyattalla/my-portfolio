        ...
        <div className={`js-text ${animate ? "animate-slideIn" : ""}`}>
          <p>
            <span className="js-texts">
              Hello! I am Arsany Attalla, I am a software engineer with three years of experience in developing and optimizing web applications. Holding a degree in Computer Science, I have a strong foundation in various software engineering principles and practices. My expertise includes building responsive and user-friendly web applications using JavaScript frameworks like React, alongside backend technologies such as Node.js and Express. My experience in system architecture enables me to design scalable solutions that handle high traffic while ensuring reliability and efficiency.In addition, I am skilled in database management, working with both SQL and NoSQL databases, including PostgreSQL and MongoDB, to manage data effectively and optimize query performance. I have developed and integrated RESTful APIs and microservices to enhance application functionality and facilitate seamless communication between systems.
            </span>
            <span className="js-texts">
