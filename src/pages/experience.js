      ...
      <header>
        ...
        {!selectedComponent && (
          <>
            ...
            <div className={`experience-content ${animate ? "animate-slideIn" : ""}`}>
              <div className="experience-block">
              <strong className="title0">Work Experience</strong>
                ...
                <ul>
                  <li>Developed and launched a new user interface for the company’s flagship product, resulting in a 20% increase in user engagement.</li>
                  <li>Optimized web applications for speed and scalability, reducing page load times by 35%.</li>
                  <li>Implemented responsive design techniques, enhancing user experience across all devices.</li>
                  <li>Introduced code review practices that improved code quality and reduced bugs by 15%.</li>
                  <li>Led a successful migration to React, improving maintainability and developer productivity.</li>
                </ul>
              </div>
            </div>
          </>
